...
from .contracts_v1 import DomainScore, ScoreResult, SURVEY_IDS
from .validation_v1 import resolve_branch_scores
from app.evaluation_models import SurveyGroup, SurveyResult, SurveyValue


RULES = json.loads((Path(__file__).resolve().parents[3] / "resources/rules/scoring-v1.json").read_text(encoding="utf-8"))
